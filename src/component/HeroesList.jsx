                ...
                heroes.map((hero) => {
                    return (
                        <div className="cards" key={hero.id}>
                            <h1 className="card__name">{hero.name}</h1>
                            <h3 className="card__univers"><span>Вселенная:</span> {hero.univers}</h3>
                            <h4 className="card__ego"><span>Альтер-эго:</span> {hero.alterego}</h4>
                            <p className="card__ocupat"><span>Род деятельности:</span> {hero.occupation}</p>
                            <p className="card__friends"><span>Друзья:</span> {hero.friends}</p>
                            <p className="card__suoer"><span>Суперсилы:</span> {hero.superpowers}</p>
                            <img className="card__img" src={hero.url} alt={hero.name} />
                        </div>
                    )
                })
            }
